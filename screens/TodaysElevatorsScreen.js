...
export class TodaysElevatorsScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    if (this.props.appStore.barcodeResult == false) { this.props.appStore.setElevtorSearch(null); }
  }
  ...
  render() {
    return (
      <Screen>
        ...
        <TextListHeader listType="due" listLength={this.props.appStore.dueElevators.length} isSearch={this.props.appStore.elevatorSearch} />
        <FlatList
          data={this.props.appStore.dueElevators}
